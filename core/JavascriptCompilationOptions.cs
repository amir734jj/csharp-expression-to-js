...
namespace core
{
    ...
    public class JavascriptCompilationOptions
    {
        ...
        private JavascriptCompilationOptions()
        {
            BodyOnly = true;
            ScopeParameter = true;
            Extensions = Enumerable.Empty<JavascriptConversionExtension>();
            ScriptVersion = ScriptVersion.Es51;
        ...
        {
            ScriptVersion = scriptVersion;
            BodyOnly = (flags & JsCompilationFlags.BodyOnly) != 0;
            ScopeParameter = (flags & JsCompilationFlags.ScopeParameter) != 0;
        ...
        {
            return CustomMetadataProvider ?? JavascriptMetadataProvider.Default;
        }
    }
}